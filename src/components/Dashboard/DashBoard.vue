...
export default {
    ...
    data() {
        return {
            ...
            fields: [{
                    key: 'singlish_sentence',
                    label: 'Singlish Sentence'
                },
                {
                    key: 'sinhala_sentence',
                    label: 'Sinhala Sentence'
                },
                {
                    key: 'correctness',
                    label: 'Correctness'
            ...
            currentPage: 1,
            itemsPerPage: 10,
            totalRows: 0, // Initialize with 0, will be updated after fetching data
            trainingData: {
                percentage: 85,
                count: 150
            },
    ...
    methods: {
        async getTableData() {
            try {
              const response = await getsinglish_data()
